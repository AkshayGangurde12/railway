...
//     // Validate field if it's one of our validated fields
//     if (["phone", "bloodGroup", "age"].includes(name)) {
...
//     const isBloodGroupValid = validateField("bloodGroup", formData.bloodGroup);
//     const isAgeValid = validateField("age", formData.age);
    
//     if (!isPhoneValid || !isBloodGroupValid || !isAgeValid) {
//       return;
//     }
...
//             onChange={handleFieldChange}
//             className={`shadow border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:bg-gray-50 ${
//               validationErrors.bloodGroup ? "border-red-500" : ""
//             }`}
//             placeholder="Enter blood group (e.g., A+, B-, AB+)"
//             autoComplete="off"
//             required
//           />
//           {validationErrors.bloodGroup && (
//             <p className="text-red-500 text-xs italic">{validationErrors.bloodGroup}</p>
//           )}
//         </div>
//         {/* Age */}
//         <div className="mb-4">
...
//             <p className="text-red-500 text-xs italic">{validationErrors.age}</p>
//           )}
//         </div>
//         {/* Additional Fields */}
//         {Object.keys(formData)
...
//                 className="shadow border rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:bg-gray-50"
//                 autoComplete="off"
//                 required={field !== "allergies" && field !== "vaccinationHistory"}
//               />
//             </div>
//           ))}
//       </div>
...
//             validationErrors.phone || 
//             validationErrors.bloodGroup || 
//             validationErrors.age ? "opacity-50 cursor-not-allowed" : ""
//           }`}
//         >
//           {loading ? "Updating..." : "Save"}
//         </button>
